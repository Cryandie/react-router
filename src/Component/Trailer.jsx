...
export const Trailer = ({match}) => {
    ...
    return (
        <div >
              ...
              <iframe src={movie.trailerUrl}title={movie.title}  width="860" height="515"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="true"></iframe>
             </div>
